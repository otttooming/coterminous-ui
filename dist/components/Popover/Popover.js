...
class PopoverBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_popper_1.Manager, null,
            ...
            this.props.isOpen && (React.createElement(react_popper_1.Popper, { placement: "bottom" }, ({ ref, style, placement, arrowProps }) => (React.createElement("aside", { ref: ref, style: style, "data-placement": placement }, this.props.popoverChildren()))))));
    }
}
