...
export declare const H4Style: (string | number | false | Styles | StyledComponentClass<any, any, any> | InterpolationFunction<ThemeProps<NextStyledThemeProps>>)[];
export declare const H5Style: (string | number | false | Styles | StyledComponentClass<any, any, any> | InterpolationFunction<ThemeProps<NextStyledThemeProps>>)[];
export declare const H6Style: (string | number | false | Styles | StyledComponentClass<any, any, any> | InterpolationFunction<ThemeProps<NextStyledThemeProps>>)[];
